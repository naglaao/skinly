...
# Allowing an image to be used as a button
class ImageButton(ButtonBehavior, Image):
    pass

# Creating a selectable image button widget with button behavior
...
# Defining LabelButton widget to act like a button
